...
const SYSTEM_PROMPT = `Bạn là trợ lý AI cá nhân của KIM AI (sieuthisoai.com) — nền tảng thương mại điện tử sản phẩm số AI Việt Nam.
    ...
    const tools: any[] = [
      {
        ...
        description: "Tìm kiếm sản phẩm trên nền tảng Kim AI theo từ khoá",
        input_schema: {
          type: "object",
          properties: {
