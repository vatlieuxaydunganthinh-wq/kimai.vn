...
export const apps: AppProduct[] = [
  ...
  },
  {
    ...
    desc: "Prompt AI giữ đồng bộ thương hiệu khi tạo ảnh, poster: đúng màu sắc, đúng font, đúng giọng văn ngay từ lần đầu. Dán 1 lần, áp dụng cho mọi nội dung sau này.",
  ...
  },
  {
    ...
    desc: "Prompt AI lập kế hoạch từng bước trước khi thực hiện, tránh sửa đi sửa lại vì thiếu định hướng. Dùng cho mọi dự án nhiều bước: content, thiết kế, tổ chức sự kiện.",
  ...
  },
  {
    ...
    desc: "Prompt AI thiết kế giao diện website có gu thẩm mỹ riêng, không rập khuôn mẫu có sẵn. Áp dụng ngay cho landing page, app, dashboard bán hàng.",
  ...
  },
  {
    ...
    desc: "Prompt AI tìm lỗi có hệ thống: xác định đúng nguyên nhân gốc trước khi sửa, không vá bừa rồi lỗi tái phát. Quy trình 4 bước áp dụng cho code lẫn quy trình vận hành.",
  ...
  },
  {
    ...
    desc: "AI vẽ poster, thiệp bằng code — ra file PNG/PDF sắc nét, chỉnh từng chi tiết theo ý bạn. Không phụ thuộc may rủi của công cụ vẽ ảnh ngẫu nhiên.",
  ...
  },
  {
    ...
    desc: "Prompt AI đặt tiêu chí đạt/không đạt trước khi làm việc — biết chắc chắn khi nào công việc thực sự hoàn thành. Áp dụng cho cả code lẫn nội dung, sản phẩm.",
  ...
  },
  {
    ...
    desc: "Prompt AI viết thông báo, bản tin nội bộ chuyên nghiệp: tóm tắt rõ ràng, hành động cụ thể, đúng hạn chót. Dùng cho team, cộng tác viên, affiliate.",
  ...
  },
  {
    ...
    desc: "Prompt AI thực thi kế hoạch đúng từng bước, báo cáo tiến độ, dừng lại xin ý kiến ở điểm quan trọng. Bạn luôn kiểm soát được tiến độ công việc.",
  ...
  },
  {
    ...
    desc: "Prompt AI tạo bộ màu sắc và font chữ chuyên nghiệp theo đúng ngành của bạn — không cần tự mò mẫm chọn màu từ con số 0.",
  ...
  },
  {
    ...
    desc: "Prompt AI chuẩn bị yêu cầu review đầy đủ ngữ cảnh — nhận phản hồi chất lượng hơn, không mất thời gian giải thích lại từ đầu.",
  ...
  },
  {
    ...
    desc: "AI dựng web app, công cụ nội bộ hoàn chỉnh ngay trong 1 lần trò chuyện — không cần biết code, không cần thuê lập trình viên.",
  ...
  },
  {
    ...
    desc: "Prompt AI đánh giá kỹ góp ý trước khi sửa — tránh làm bừa theo phản hồi sai, không sửa xong lỗi này lại sinh lỗi khác.",
  ...
  },
  {
    ...
    desc: "Hướng dẫn kết nối AI trực tiếp với hệ thống, database của bạn qua MCP server — tra cứu, cập nhật dữ liệu tự động, không copy-paste thủ công.",
  ...
  },
  {
    ...
    desc: "Hướng dẫn làm song song nhiều nhánh công việc an toàn bằng git worktree — thử nghiệm hướng mới không ảnh hưởng bản đang chạy ổn định.",
  ...
  },
  {
    ...
    desc: "AI tạo hoạ tiết, hoa văn độc quyền bằng thuật toán — đổi 1 tham số ra ngay hàng loạt biến thể mới, không tốn công làm lại từ đầu.",
  ...
  },
  {
    ...
    desc: "Checklist hoàn tất công việc dứt điểm: kiểm tra lại, gộp bản chính, dọn dẹp — không còn việc dở dang bị bỏ quên.",
  ...
  },
  {
    ...
    desc: "Viết tài liệu quan trọng cùng AI theo từng phần, góp ý ngay lập tức — thành phẩm vẫn giữ đúng giọng văn của bạn, không bị AI viết thay.",
  ...
  },
  {
    ...
    desc: "Chia việc lớn cho nhiều AI làm song song từng phần độc lập — rút ngắn đáng kể thời gian hoàn thành so với làm tuần tự.",
  ...
  },
  {
    ...
    desc: "Hướng dẫn tích hợp AI trực tiếp vào website, app: chatbot chăm sóc khách, tự động hoá nội dung — không cần đội kỹ thuật riêng.",
  ...
  },
  {
    ...
    desc: "Hướng dẫn tự tạo skill AI riêng từ quy trình bạn hay làm — dán 1 lần, dùng lại mãi mãi, không phải giải thích lại từ đầu.",
  ...
  },
  {
    ...
    desc: "AI tạo GIF động ngắn, đúng dung lượng cho Zalo, Facebook story — không lo file nặng, vỡ hình khi đăng.",
  ...
  },
  {
    ...
    desc: "Prompt giúp AI tự chọn đúng skill trong bộ bạn đang có — không cần nhớ hết 27 skill để biết dùng cái nào lúc nào.",
  ...
  },
  {
    ...
    desc: "AI tự động test website như người dùng thật, báo lỗi kèm cách tái hiện — phát hiện sự cố trước khi khách hàng gặp phải.",
  ...
  },
  {
    ...
    desc: "Giao nhiều việc độc lập cho nhiều AI chạy song song — việc vốn mất cả buổi giờ xong chỉ trong vài phút.",
  ...
  },
  {
    ...
    desc: "Hướng dẫn chính thức tự thiết kế skill AI mới đúng chuẩn — đủ rõ ràng để AI hiểu và làm đúng ý ngay từ lần đầu.",
  ...
  },
  {
    ...
    desc: "Prompt bắt AI xác minh bằng chứng cụ thể trước khi báo 'đã xong' — chấm dứt tình trạng báo cáo sai khiến bạn mất niềm tin.",
