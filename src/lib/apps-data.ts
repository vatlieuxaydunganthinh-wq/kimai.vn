...
export const apps: AppProduct[] = [
  ...
  },
  {
    ...
    desc: "AI ngừng đoán mò yêu cầu của bạn — hỏi đúng câu, đúng lúc, rồi mới bắt tay làm. Kèm ví dụ thật (trước/sau khi dùng skill), dùng ngay cho content bán hàng, đặt tên sản phẩm, trả lời khách khó tính.",
