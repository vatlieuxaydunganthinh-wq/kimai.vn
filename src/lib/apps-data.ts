...
export const apps: AppProduct[] = [
  ...
  },
  {
    ...
    desc: "Biến ý tưởng mơ hồ thành kế hoạch rõ ràng. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "Turns vague ideas into clear plans by having AI ask the right clarifying questions. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1001,
    title: "SKILL AI ĐỒNG BỘ THƯƠNG HIỆU — KIMAI2",
    titleEn: "AI Skill: Brand Guidelines — Kimai2",
    desc: "Giữ màu sắc, font, giọng văn thương hiệu nhất quán khi dùng AI tạo nội dung. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "Keeps brand colors, fonts and voice consistent across every AI-generated asset. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1002,
    title: "SKILL AI LẬP KẾ HOẠCH TRƯỚC KHI LÀM — KIMAI3",
    titleEn: "AI Skill: Writing Plans — Kimai3",
    desc: "Bắt AI viết kế hoạch từng bước trước khi thực thi, tránh làm bừa. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "Forces a clear step-by-step plan before any execution — review before work starts. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1003,
    title: "SKILL AI THIẾT KẾ GIAO DIỆN CÓ GU — KIMAI4",
    titleEn: "AI Skill: Frontend Design — Kimai4",
    desc: "Giúp AI thiết kế giao diện có chủ đích, không rập khuôn nhàm chán. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "Guides AI to design with deliberate style choices instead of generic templates. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1004,
    title: "SKILL AI TÌM LỖI CÓ HỆ THỐNG — KIMAI5",
    titleEn: "AI Skill: Systematic Debugging — Kimai5",
    desc: "Truy tìm nguyên nhân gốc trước khi sửa, không đoán mò. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "Traces the true root cause before proposing any fix — no more guesswork. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1005,
    title: "SKILL AI VẼ THIẾT KẾ BẰNG CODE — KIMAI6",
    titleEn: "AI Skill: Canvas Design — Kimai6",
    desc: "Tạo poster, thiệp, hình minh hoạ chính xác từng chi tiết bằng code. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "Draws pixel-precise posters, cards and illustrations directly with code. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1006,
    title: "SKILL AI ĐẶT TIÊU CHUẨN TRƯỚC KHI LÀM — KIMAI7",
    titleEn: "AI Skill: Test-Driven Development — Kimai7",
    desc: "Viết rõ tiêu chí đạt/không đạt trước khi bắt tay làm việc. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "Defines clear success criteria before work begins, then checks results against it. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1007,
    title: "SKILL AI VIẾT THÔNG BÁO NỘI BỘ — KIMAI8",
    titleEn: "AI Skill: Internal Comms — Kimai8",
    desc: "Viết thông báo, bản tin nội bộ rõ ràng, đúng trọng tâm, đúng giọng điệu. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "Writes clear, well-structured internal announcements and newsletters. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1008,
    title: "SKILL AI THỰC THI KẾ HOẠCH CÓ KIỂM SOÁT — KIMAI9",
    titleEn: "AI Skill: Executing Plans — Kimai9",
    desc: "Thực thi từng bước kế hoạch, báo cáo tiến độ, dừng lại ở điểm quan trọng. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "Executes an approved plan step by step with progress checkpoints. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1009,
    title: "SKILL AI TẠO BỘ THEME MÀU SẮC — KIMAI10",
    titleEn: "AI Skill: Theme Factory — Kimai10",
    desc: "Đề xuất bộ màu sắc và font chữ chuyên nghiệp, hài hoà cho sản phẩm số. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "Proposes a cohesive professional color palette and font pairing in seconds. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1010,
    title: "SKILL AI CHUẨN BỊ YÊU CẦU REVIEW — KIMAI11",
    titleEn: "AI Skill: Requesting Code Review — Kimai11",
    desc: "Chuẩn bị yêu cầu review đầy đủ ngữ cảnh, nhận phản hồi chất lượng hơn. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "Structures review requests with full context so reviewers give sharper feedback. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1011,
    title: "SKILL AI DỰNG WEB APP HOÀN CHỈNH — KIMAI12",
    titleEn: "AI Skill: Web Artifacts Builder — Kimai12",
    desc: "Xây web app/công cụ nội bộ hoàn chỉnh bằng React + Tailwind ngay trong hội thoại. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "Builds a complete self-contained React + Tailwind web app in one conversation. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1012,
    title: "SKILL AI XỬ LÝ GÓP Ý ĐÚNG CÁCH — KIMAI13",
    titleEn: "AI Skill: Receiving Code Review — Kimai13",
    desc: "Đánh giá kỹ góp ý trước khi áp dụng, không làm bừa theo phản hồi sai. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "Evaluates incoming feedback critically before applying any change. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1013,
    title: "SKILL AI KẾT NỐI VỚI HỆ THỐNG NGOÀI — KIMAI14",
    titleEn: "AI Skill: MCP Builder — Kimai14",
    desc: "Hướng dẫn xây MCP server để AI thao tác trực tiếp với hệ thống/database của bạn. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "Guides you through building an MCP server so AI can act on your own systems. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1014,
    title: "SKILL AI LÀM SONG SONG NHIỀU NHÁNH VIỆC — KIMAI15",
    titleEn: "AI Skill: Git Worktrees — Kimai15",
    desc: "Thử nghiệm hướng mới an toàn song song, không ảnh hưởng bản đang chạy ổn định. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "Runs safe parallel experiments without touching your stable production branch. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1015,
    title: "SKILL AI TẠO NGHỆ THUẬT SINH TẠO — KIMAI16",
    titleEn: "AI Skill: Algorithmic Art — Kimai16",
    desc: "Tạo hoạ tiết, hoa văn độc quyền bằng thuật toán, chỉnh tham số ra hàng loạt biến thể. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "Generates unique algorithmic patterns you can tweak into endless variations. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1016,
    title: "SKILL AI HOÀN TẤT CÔNG VIỆC DỨT ĐIỂM — KIMAI17",
    titleEn: "AI Skill: Finishing a Branch — Kimai17",
    desc: "Quy trình chốt việc chuẩn chỉnh: kiểm tra lại, gộp bản chính, dọn dẹp. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "A clean checklist to finish, merge and tidy up finished work — no loose ends. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1017,
    title: "SKILL AI ĐỒNG SÁNG TÁC TÀI LIỆU — KIMAI18",
    titleEn: "AI Skill: Doc Co-authoring — Kimai18",
    desc: "Viết tài liệu quan trọng cùng AI theo từng phần, giữ đúng giọng văn của bạn. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "Co-writes important documents section by section, keeping your own voice. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1018,
    title: "SKILL AI ĐIỀU PHỐI NHIỀU AI PHỤ TÁ — KIMAI19",
    titleEn: "AI Skill: Subagent-Driven Development — Kimai19",
    desc: "Chia việc lớn cho nhiều AI phụ tá làm song song từng phần độc lập. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "Splits large independent tasks across multiple AI helpers working in parallel. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1019,
    title: "SKILL AI TÍCH HỢP AI VÀO SẢN PHẨM — KIMAI20",
    titleEn: "AI Skill: Claude API — Kimai20",
    desc: "Hướng dẫn đưa AI trực tiếp vào website/app: chatbot, tự động hoá nội dung. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "A practical guide to embedding AI chat and automation directly into your product. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1020,
    title: "SKILL AI TỰ TẠO SKILL RIÊNG — KIMAI21",
    titleEn: "AI Skill: Writing Skills — Kimai21",
    desc: "Đóng gói quy trình lặp lại thành 1 skill AI tái sử dụng được mãi mãi. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "Packages any repeated workflow into a reusable AI skill you use forever. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1021,
    title: "SKILL AI TẠO GIF ĐỘNG — KIMAI22",
    titleEn: "AI Skill: GIF Creator — Kimai22",
    desc: "Tạo GIF động ngắn, vui nhộn cho nhóm chat và mạng xã hội. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "Creates short, fun animated GIFs optimized for chat apps and social stories. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1022,
    title: "SKILL AI KHAI THÁC TRỌN BỘ SKILL — KIMAI23",
    titleEn: "AI Skill: Using Superpowers — Kimai23",
    desc: "Giúp AI tự nhận ra lúc nào nên dùng skill nào trong bộ skill bạn đang có. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "Helps AI automatically pick the right skill from your toolkit at the right moment. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1023,
    title: "SKILL AI TỰ ĐỘNG TEST WEBSITE — KIMAI24",
    titleEn: "AI Skill: Webapp Testing — Kimai24",
    desc: "AI tự thao tác thử website như người dùng thật, phát hiện lỗi trước khi ra mắt. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "AI walks through your site like a real user to catch bugs before customers do. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1024,
    title: "SKILL AI GIAO VIỆC SONG SONG — KIMAI25",
    titleEn: "AI Skill: Dispatching Parallel Agents — Kimai25",
    desc: "Giao nhiều việc độc lập cho nhiều AI làm cùng lúc, rút ngắn thời gian hoàn thành. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "Dispatches independent tasks to multiple AI agents running at the same time. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1025,
    title: "SKILL AI TỰ THIẾT KẾ SKILL MỚI — KIMAI26",
    titleEn: "AI Skill: Skill Creator — Kimai26",
    desc: "Bộ hướng dẫn chính thức giúp tự thiết kế skill AI mới đúng chuẩn. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "The official, structured guide to designing a brand-new AI skill correctly. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
  ...
  {
    n: 1026,
    title: "SKILL AI XÁC MINH TRƯỚC KHI BÁO XONG — KIMAI27",
    titleEn: "AI Skill: Verification Before Completion — Kimai27",
    desc: "Bắt buộc xác minh kết quả thực tế trước khi báo cáo đã hoàn thành. Đóng gói từ mã nguồn mở (giấy phép mở, viết lại tiếng Việt), tải file hướng dẫn .md dùng ngay.",
    descEn: "Forces real verification with evidence before anything is declared 'done'. Repackaged from a permissively-licensed open-source skill, rewritten and delivered as a ready-to-use .md guide.",
