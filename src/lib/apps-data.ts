...
export const apps: AppProduct[] = [
  ...
  },
  {
    ...
    desc: "AI ngừng đoán mò yêu cầu của bạn — hỏi đúng câu, đúng lúc, rồi mới bắt tay làm. Tải file .md, dán 1 lần, dùng cho mọi dự án sau này.",
    descEn: "AI stops guessing what you want — it asks the right question at the right time before doing any work. Download the .md file once, reuse it on every project.",
  ...
  },
  {
    ...
    desc: "Mọi ảnh, poster AI tạo ra đều đúng màu, đúng font thương hiệu ngay từ lần đầu — không còn lệch pha giữa các lần tạo. Dán 1 lần, áp dụng cho mọi nội dung sau này.",
  ...
  },
  {
    ...
    desc: "AI viết kế hoạch từng bước và chờ bạn duyệt trước khi làm — chấm dứt cảnh sửa đi sửa lại vì thiếu định hướng ngay từ đầu. Dùng được cho mọi task nhiều bước.",
  ...
  },
  {
    ...
    desc: "Giao diện AI thiết kế có màu sắc, bố cục do bạn chủ động chọn — không còn website nào cũng giống nhau. Áp dụng ngay từ lần thiết kế tiếp theo.",
  ...
  },
  {
    ...
    desc: "AI tìm đúng nguyên nhân gốc trước khi đề xuất sửa lỗi — không vá bừa rồi lỗi tái phát ở chỗ khác. Quy trình 4 bước rõ ràng, dùng ngay.",
  ...
  },
  {
    ...
    desc: "AI vẽ trực tiếp bằng code, ra file PNG/PDF sắc nét, chỉnh được từng chi tiết theo đúng ý bạn — không phụ thuộc may rủi của công cụ vẽ ảnh ngẫu nhiên.",
  ...
  },
  {
    ...
    desc: "Đặt tiêu chí đạt/không đạt trước khi làm — bạn biết chắc chắn khi nào việc thực sự xong, không còn tranh cãi 'đã ổn chưa'.",
  ...
  },
  {
    ...
    desc: "Thông báo nội bộ có cấu trúc rõ ràng: tóm tắt đầu bài, hành động cụ thể, hạn chót rõ ràng — nhân viên đọc xong hiểu ngay, không cần hỏi lại.",
  ...
  },
  {
    ...
    desc: "AI thực hiện đúng từng bước của kế hoạch đã duyệt, báo cáo tiến độ, dừng lại xin ý kiến ở điểm quan trọng — bạn luôn nắm được tiến độ thực tế.",
  ...
  },
  {
    ...
    desc: "Có ngay bộ màu sắc và font chữ chuyên nghiệp, phối hợp hài hoà theo đúng ngành của bạn — không phải tự mò mẫm chọn màu từ con số 0.",
  ...
  },
  {
    ...
    desc: "Chuẩn bị yêu cầu review đủ ngữ cảnh ngay từ đầu — người review không mất thời gian hỏi lại, phản hồi bạn nhận được đi thẳng vào vấn đề thật.",
  ...
  },
  {
    ...
    desc: "AI dựng nguyên 1 web app dùng được ngay trong 1 lần trò chuyện — không cần biết code, không cần thuê lập trình viên cho việc nhỏ.",
  ...
  },
  {
    ...
    desc: "Đánh giá kỹ từng góp ý trước khi sửa — không làm bừa theo phản hồi sai, tránh sửa xong lỗi này lại sinh ra lỗi khác.",
  ...
  },
  {
    ...
    desc: "Kết nối AI thẳng vào hệ thống của bạn để tra đơn hàng, cập nhật dữ liệu tự động — không còn copy-paste thủ công qua lại giữa các công cụ.",
  ...
  },
  {
    ...
    desc: "Thử nghiệm hướng đi mới song song, an toàn — không đụng vào bản đang chạy ổn định và đang phục vụ khách hàng thật.",
  ...
  },
  {
    ...
    desc: "Tạo hoạ tiết độc quyền bằng thuật toán — đổi 1 tham số là ra ngay hàng loạt biến thể mới, không tốn công làm lại từ đầu.",
  ...
  },
  {
    ...
    desc: "Checklist rõ ràng để chốt dứt điểm 1 công việc: kiểm tra lại, gộp vào bản chính, dọn dẹp — không còn việc dở dang bị bỏ quên.",
  ...
  },
  {
    ...
    desc: "Viết tài liệu quan trọng cùng AI theo từng phần, góp ý ngay lập tức — thành phẩm cuối cùng vẫn giữ đúng giọng văn của bạn, không bị AI viết thay hoàn toàn.",
  ...
  },
  {
    ...
    desc: "Chia việc lớn cho nhiều AI làm song song từng phần độc lập — rút ngắn đáng kể thời gian hoàn thành so với làm tuần tự từng bước.",
  ...
  },
  {
    ...
    desc: "Hướng dẫn từng bước đưa AI thẳng vào website/app của bạn: chatbot, tự động hoá nội dung — không cần thuê riêng đội kỹ thuật.",
  ...
  },
  {
    ...
    desc: "Đóng gói quy trình bạn hay làm thành 1 skill dùng lại được mãi mãi — dán 1 lần, không phải giải thích lại từ đầu cho AI mỗi lần dùng.",
  ...
  },
  {
    ...
    desc: "Tạo GIF động ngắn, đúng dung lượng cho từng nền tảng (Zalo, Facebook story...) — không còn lo file nặng, vỡ hình khi đăng lên.",
  ...
  },
  {
    ...
    desc: "AI tự nhận ra nên dùng skill nào trong bộ bạn đang sở hữu — bạn không cần nhớ hết 27 skill để chọn đúng cái mình cần lúc đó.",
  ...
  },
  {
    ...
    desc: "AI tự thao tác thử website của bạn như khách hàng thật, báo lỗi kèm cách tái hiện lại chính xác — phát hiện sự cố trước khi khách hàng gặp phải.",
  ...
  },
  {
    ...
    desc: "Giao nhiều việc độc lập cho nhiều AI chạy cùng lúc — việc vốn mất cả buổi giờ xong chỉ trong vài phút.",
  ...
  },
  {
    ...
    desc: "Bộ hướng dẫn chính thức để tự thiết kế 1 skill AI mới đúng chuẩn — đủ rõ ràng để AI hiểu và làm đúng ý ngay từ lần đầu.",
  ...
  },
  {
    ...
    desc: "Bắt buộc xác minh bằng chứng cụ thể trước khi báo 'đã xong' — chấm dứt tình trạng báo cáo sai khiến bạn mất niềm tin vào kết quả.",
