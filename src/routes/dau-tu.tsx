...
export const Route = createFileRoute("/dau-tu")({
  head: () => ({ meta: [{ title: "Cơ hội Đầu tư & Hợp tác — AI Digital Supermarket" }] }),
  component: PitchPage,
});
...
function PitchPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const subject = encodeURIComponent("Quan tâm đầu tư / mua lại AI Digital Supermarket");
  ...
  return (
    <div className="min-h-screen bg-[#0a0a14] text-white font-sans">
      ...
      <footer className="text-center pb-10 text-white/20 text-xs">
        © 2025 AI Digital Supermarket · Thịnh Vua App
      </footer>
    </div>
  );
}
