...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "KIM AI - Affiliate Kiếm Tiền" },
      { name: "description", content: "ĐĂNG KÝ LINK - Affiliate Kiếm Tiền với SP/DV của Kim AI" },
      { name: "author", content: "Kim AI" },
      { property: "og:title", content: "KIM AI - Affiliate Kiếm Tiền" },
      { property: "og:description", content: "ĐĂNG KÝ LINK - Affiliate Kiếm Tiền với SP/DV của Kim AI" },
